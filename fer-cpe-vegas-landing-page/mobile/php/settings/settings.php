<?php
	...
	------------------------------------------------------ */	
	$receiver_subject = "New inquiry from the FER landing page contact form!";
	...
	------------------------------------------------------ */
	$receiver_email = "no-reply@FER-CPE-Getawway.com";
	...
	----------------------------------------------------------------------------- */	
	$redirectForm = true;
	$redirectForm_url = "http://infocusadv.com/fer-live/mobile/thankyou.php";
	
	/* Powered BY
	 * You will use both your website NAME and URL
	 * By default its powered by SMARTFORMS - http://www.doptiq.com/smart-forms
	----------------------------------------------------------------------------- */
	$poweredby_name = "FER Landing Page";
	$poweredby_url = "http://infocusadv.com/fer-live/";	
