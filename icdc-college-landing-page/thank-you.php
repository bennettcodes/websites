...
<link rel="stylesheet" type="text/css" href="css/style-important.css" />
...
<div id="header-main">
      <div id="header-left">
        ...
        CAMPUS and ONLINE CAREER COLLEGE<br>
        <span style="font-weight:400;">Providing Career Training for Over 20 Years</span></div>
      <div id="header-right"><span style="font-size:32px; color:#ffffff; line-height:34px;"><span style="font-weight:300;">CALL</span> NOW!</span><br>
        888.255.5987</div>
    </div>
  </div>
  <div id="content">
...
<div class="slider" style="height:855px;">
      ...
      <img class="slide" src="images/slider/slide4.jpg" />
...
<div id="story-player2"><iframe width="950" height="534" src="https://www.youtube.com/embed/fIb_mpx29TI" frameborder="0" allowfullscreen></iframe></div>
...
<div id="general-container">
    <div id="general">
      <div id="why-choose">
      <div id="why-choose-headers">
      <div id="click-here-stories"><span style="line-height:36px; font-size:30px; color:#e92b36;">Click here</span><br>
to hear success stories from some of our students!</div>
        <div id="why-choose-header1">Why Choose<br>
<span style="color:#e92b36;">ICDC College?</span></div>
        </div>
        <div id="why-choose-table-container">
          <div id="why-choose-table">
            <div id="why-choose-table-cell1"> </div>
            <div id="why-choose-table-cell1-text-container" class="cell-long">
            ...
            <div id="why-choose-table-cell2-text-container" class="cell-short">
            ...
            <div id="why-choose-table-cell3-text-container" class="cell-short">
            ...
            <div id="why-choose-table-cell4-text-container" class="cell-short">
            ...
            <div id="why-choose-table-cell5-text-container" class="cell-short">
            ...
            <div id="why-choose-table-cell6-text-container" class="cell-long">
...
Now, <span style="color:#e92b36;">Today!</span></div>
          <div id="fields-bullets">
            <ul>
              <li><div class="program-title" style="color:#000000;"><div class="program-description">
              
              <h1>Healthcare Management</h1>
<h2><br>
The Medical Field Needs Trained Leaders Like You.</h2>
<p><br>
Healthcare administrators
ensure that medical facilities
are operated efficiently to provide
optimum quality patient care.
Learn to help manage the
operations of a treatment center,
clinic, or other medical office.</p>
<h3><br>
Program Highlights:<br>
<br>
</h3>
<ul>
<li>Healthcare Business Management</li>
<li>Anatomy</li>
<li>Electronic Health Records (EHR)</li>
<li>Workplace Management</li>
<li>Billing and Payroll Management</li>
</ul>
              
</div>Healthcare Management<div class="program-expand">Learn More!</div></div></li>
              <li><div class="program-title" style="color:#000000;"><div class="program-description">
              
              <h1>Alcohol and Drug Counseling</h1>
<h2><br>
Save Lives, Connect Families, and Help Fight Addiction.</h2>
<p><br>
Help others overcome their addictions by paving the road
to recovery. Develop the skill sets needed to treat addictive
behaviors, prevent addiction, manage cases, and facilitate
individual, group, and family counseling techniques.</p>
<h3><br>
Program Highlights:<br>
<br>
</h3>
...
<li>12 Core Functions of Substance Abuse Counseling and Eight Domains
of Knowledge in the Field of Addiction</li>
<li>Prevention, Education, Outreach, and Referral Strategies</li>
<li>Pharmacology</li>

</ul>
              
              </div>Alcohol and Drug Counseling<div class="program-expand">Learn More!</div></div></li>
              <li><div class="program-title" style="color:#000000;"><div class="program-description">
              
              <h1>Homeland Security and Investigation</h1>
<h2><br>
Help Defend and Respond to Safety Threats
and Natural Disasters.</h2>
<p><br>
Be part of the solution to emergencies and security threats
with a program that blends hands-on training with real-life
case studies. The program combines law enforcement,
response strategies, security services, and more into an
exciting career path.</p>
<h3><br>
Special Features:*<br>
<br>
</h3>
...
<li>Chemical Agents, Firearms,
and Baton Training</li>
<li>Guard Card and Patrol Officer
License Eligibility</li>
...
*Certain restrictions may apply.</p>
              ...
              </div>Homeland Security and Investigation<div class="program-expand">Learn More!</div></div></li>
              <li><div class="program-title" style="color:#000000;"><div class="program-description">
              
              <h1>Paralegal</h1>
<h2><br>
Investigate Facts and Assist Lawyers
Inside and Outside the Courtroom.</h2>
<p><br>
Assist attorneys by interviewing clients, organizing legal documents, and helping prepare for trial.</p>
<h3><br>
Program Highlights:<br>
<br>
</h3>
...
<li>Immigration/constitutional law</li>
<li>Legal office procedures</li>
<li>Contract and criminal law</li>
<li>Civil procedures and civil litigation</li>
<li>Property law and bankruptcy law</li>
<li>Family law</li>
</ul>
              
              </div>Paralegal<div class="program-expand">Learn More!</div></div></li>
              <li><div class="program-title" style="color:#000000;"><div class="program-description">
              
              <h1>Business Management and Accounting</h1>
<h2><br>
Become a Skilled Business Professional.</h2>
<p><br>
Take the business world in your hands and learn fundamental skills
like office management, finance, and payroll.</p>
<h3><br>
Program Highlights:<br>
<br>
</h3>
<ul>
<li>Entrepreneurship and Start-up Business Strategies</li>
<li>Learn to Produce and Manage Financial
Documents on QuickBooks<sup>&reg;</sup>, Sage50<sup>&reg;</sup>,
and other programs</li>
<li>Earn a Tax Preparer Certificate.
Tax Preparer Courses are approved
by the California Tax Education Council (CTEC) course# 1035-QE-0012**</li>
</ul>
<p style="font-size:10px;"><br>
<br>
*QuickBooks<sup>&reg;</sup> is a registered trademark of Intuit, Inc.
**Sage50<sup>&reg;</sup> is a registered trademark of Sage Software, Inc. and
its affiliated entities
***Certifications and additional requirements may vary by state</p>
              
              </div>Business Management and Accounting<div class="program-expand">Learn More!</div></div></li>
            </ul>
          </div>
        </div>
        <div id="laptop-burst">
...
E-Books</span><br>Included With Tuition*</div>
        </div>
      </div>
      <div id="success-stories-container">
        <div id="success-stories">
          ...
          <div id="success-stories-thumbs">
            ...
            <div class="success-stories-thumb story2" id="success-stories-thumb" style="margin-left:8px;"><img class="thumb1" src="images/harold1.jpg" /><img class="thumb2" src="images/harold2.jpg" />
              <div id="success-stories-thumb-name">HAROLD MCGEE</div>
            </div>
      ...
      <div id="first-step-container">
        <div id="first-step">
        <div id="change" style="position:absolute; top:-1px; left:0; font-size:80px; color:#ffffff; text-transform:uppercase; font-weight:800;">Change</div>
        ...
        <div id="today" style="position:absolute; top:42px; right:-3px; font-size:80px; color:#ffffff; text-transform:uppercase; font-weight:800;">Today</div>
        ...
        <div id="with-a-new-career" style="position:absolute; top:194px; right:16px; font-size:45px; line-height:38px; color:#ffffff; text-transform:uppercase; font-weight:800;"><span style="color:#ffdb31; font-size:33px; font-weight:400;">TO SPEAK TO A REPRESENTATIVE,<br>CALL NOW!</span> (888) 255-5987</div>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="js/icdc.js"></script>
