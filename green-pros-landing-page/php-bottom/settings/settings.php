<?php
	...
	------------------------------------------------------ */
	$receiver_email = "no-reply@greenpros.net";
	...
	----------------------------------------------------------------------------- */
	$poweredby_name = "Green Pros";
	$poweredby_url = "http://greenpros.net";	
