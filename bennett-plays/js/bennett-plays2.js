$(window).on('load', function() {
    ...
    *******************************************************/
    ...
    mastheadVideo.css({
        'minWidth': $(window).width() * 0.75 + 'px',
        'minHeight': $(window).height() * 0.5 + 'px'
	});
    ...
    *******************************************************/
    ...
    if (($('.masthead-video')) && ($(window).width() > 1024)) {
    $('.masthead-video').html(
    '<source src="/videos/small/just-cause-3/just-cause-3-diving-gameplay.mp4" type="video/mp4" />' +
    '<source src="/videos/small/just-cause-3/just-cause-3-diving-gameplay.webm" type="video/webm" />' 
    );
    }
