work.click(function() {
	...
	$('.navitem-active:after').css('borderWidth','0 0 0').animate({
		borderWidth:'0 0 4px'
	},250,'linear',function(){});
	$.ajax({
	type: 'GET',
...
$('#portfolio-web-sites').click(function() {
    ...
    window.location.hash = "portfolio/web-sites";
    
})
        
$('#portfolio-web-banners').click(function() {
    
    window.location.hash = "portfolio/web-banners";
    
})
        
$('#portfolio-web-eblasts').click(function() {
    
    window.location.hash = "portfolio/web-eblasts";
    
})
        
$('#portfolio-print-flyers').click(function() {
    
    window.location.hash = "portfolio/print-flyers";
    
})
        
$('#portfolio-print-brochures').click(function() {
    
    window.location.hash = "portfolio/print-brochures";
    
})
        
$('#portfolio-print-billboards').click(function() {
    
    window.location.hash = "portfolio/print-billboards";
