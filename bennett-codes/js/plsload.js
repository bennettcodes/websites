    ...
    window.onload = function () {
        ...
        $(document).ready(function () {
            ...
            var
                ...
                afterEachLoadFunctions = props.afterEachLoadFunctions || null,
                ...
                plsLoadImageParent = plsLoadImage.parent('div'),
                plsLoadImageNew,
                plsLoadPaths = [],
                newplsLoadImages = [],
            ...
            function styles() {
                //                TweenMax.set(plsLoadImageParent, {
                //                    display: 'none'
                //                });
            ...
            function keepPageAtTop() {
                if (notDone) {
                    ...
                    atTopRequest = raf(keepPageAtTop);
                } else {
                    caf(atTopRequest);
                }
            }
            ...
            function newImageLoaded() {
                setTimeout(function () {
                    plsLoadImage.eq(counter).replaceWith(newplsLoadImages[counter]);
                    plsLoadNew = $('.pls-load-new');
                    //                    plsLoadNew.hide();
                    afterEachLoadFunctions ? afterEachLoadFunctions(plsLoadNew.eq(counter)) : null;
                    counter++;
